document.addEventListener('DOMContentLoaded', () => {
    ...
    function showPlayer(streamUrl, title) {
        console.log(`[DEBUG] Showing player for ${title}`);
        console.log(`[DEBUG] landingContent: ${landingContent ? 'FOUND' : 'NULL'}`);
        console.log(`[DEBUG] playerContainer: ${playerContainer ? 'FOUND' : 'NULL'}`);
